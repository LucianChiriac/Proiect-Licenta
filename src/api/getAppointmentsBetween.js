...
async function getAppointmentsBetween(
  ...
  if (refetchData) {
    console.log("I am inside the function, and I am passing these to the api");
    console.log(info.startStr, info.endStr, refetchData);
    try {
...
//   try {
//     const responseAppointments = await fetch(
//       `https://zknyo7t9m3.execute-api.eu-west-3.amazonaws.com/dev/appointments/${prop.startStr}/${prop.endStr}`
//     );
//     const resAppointments = await responseAppointments.json();
